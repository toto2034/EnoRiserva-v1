...
<%@ page session="true" %>
<%-- La variabile 'ctx' rende i percorsi assoluti e robusti --%>
...
<%--
    Questo controllo logico per la navbar è ridondante.
    Se l'utente è su questa pagina, la sessione esiste.
    Manteniamo la versione con "navbarLogin" per coerenza.
--%>
...
<%-- Spostato il footer alla fine del body per una struttura HTML più standard --%>
